...
# General
tf.flags.DEFINE_float("dropout_keep_prob", 0.3, "Dropout keep probability."
...
tf.flags.DEFINE_integer("checkpoint_every", 200, "Evaluate model on dev set after this many steps (default: 100)")
tf.flags.DEFINE_integer("output_every", 1, "Output current training error after this many steps (default: 1)")
tf.flags.DEFINE_float("learning_rate", 1e-3, "Adam Optimizer learning rate (default: 1e-4)")
...
tf.flags.DEFINE_string("label", "GloVe", "Additional label to append to experiment"
    ...
    with sess.as_default():
        ...
        if FLAGS.lstm:
            ...
            model = TextLSTM(sequence_length=x_train.shape[1],
                             ...
                             lambda_l2_reg=FLAGS.l2_reg_lambda,
